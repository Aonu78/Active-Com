...
Route::group(['namespace' => 'App\Http\Controllers\Seller', 'prefix' => 'seller', 'middleware' => ['seller', 'verified', 'user', 'prevent-back-history'], 'as' => 'seller.'], function () {
    ...
    Route::controller(ProductController::class)->group(function () {
        ...
        Route::post('/enlist-product', 'enlistProducts')->name('products.enlist.product');
        Route::get('/products/listed',  'listedProducts')->name('products.listed');
        Route::get('/products/warehouse',  'product_warehouse')->name('products.warehouse');
        Route::post('/unlist-product/{id}', 'unlistProduct')->name('products.unlist');
    ...
    Route::controller(OrderController::class)->group(function () {
        Route::post('/orders/verify-transaction-pin', 'verifyTransactionPin')->name('orders.verify_transaction_pin');
