    ...
    <div class="card">
        <form class="" id="sort_products" action="" method="GET">
            <div class="card-header row gutters-5">
                <div class="col">
                    <h5 class="mb-md-0 h6">{{ translate('All Products') }} (listed -> {{$count_listed}})</h5>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-group mb-0 text-left">
                                        <button id="enlist-{{ $product->id }}" type="button" onclick="enlist_to_user_product({{ $product->id }})" class="btn btn-primary btn-sm rounded-2 w-120px">Listed</button>
                                    </div>
                                </td>
                                 <td>
                                    <div class="form-group mb-0 text-left">
