                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between mt-3">
                        <div class="d-flex align-items-center">
                            ...
                            <p class="fs-12 text-light my-2 ml-1">{{ translate('Views').' '.$authUser->shop?->no_of_views }}</p>
                        </div>
                        <div class="d-flex align-items-center">
                            <p class="fs-12 text-light my-2 ml-1">{{ translate('Ratings') }}</p>
                            <p class="fs-12 text-light my-2 ml-1">{{ renderStarRating($authUser->shop?->rating) }}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
                            <p class="small text-muted mb-0">
                                <span class="fe fe-arrow-down fe-12"></span>
                                <span class="fs-14 text-light">Shop Balance</span>
                            </p>
                            <h3 class="mb-0 text-white fs-30">
                                ${{ $authUser->balance }}
                            </h3>
