    ...
    <div class="modal-body">
      <table class="table table-striped table-bordered" >
        ...
        @if ($user->balance > 0)
            ...
            <div class="form-group row">
                <label class="col-sm-3 col-from-label" for="payment_decision">{{ translate('Payment Decision') }}</label>
                <div class="col-sm-9">
                    <select name="payment_decision" id="payment_decision" class="form-control" required>
                        <option value="">{{ translate('Select Decision') }}</option>
