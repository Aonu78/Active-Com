            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        @php
                            $pending_withdraw_count = \App\Models\SellerWithdrawRequest::where('status', 0)->count();
                        @endphp
                        <li class="aiz-side-nav-item">
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        @php
                            $pending_recharge_count = \App\Models\Wallet::where('approval', 0)->where('offline_payment', 1)->count();
                        @endphp
                        <li class="aiz-side-nav-item">
